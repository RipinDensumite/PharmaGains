...
<body bgcolor="black">
    <nav style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center;">
        <p style="color: white;">PharmaGains</p>
        <div>
        ...
        <table align="center" border="4" bgcolor="#734FB7">
            ...
            <td>
                <div style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
                    ...
                    <span style="color: white; font-weight: bold;"><?php echo $product['price']; ?></span>
